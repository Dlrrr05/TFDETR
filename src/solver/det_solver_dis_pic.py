...
class DetSolver(BaseSolver):
    ...
    def fit(self, ):
        ...
        for epoch in range(start_epcoch, args.epoches):
            ...
            det_iou_threshold=getattr(self.cfg, 'det_iou_threshold', 0.5),
            save_dir=self.output_dir,
            enable_tf_vis=getattr(self.cfg, 'enable_tf_vis', True),
            tf_vis_batches=getattr(self.cfg, 'tf_vis_batches', 20),
            tf_mask_examples=getattr(self.cfg, 'tf_mask_examples', 8),
        )
